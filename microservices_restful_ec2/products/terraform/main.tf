...
resource "aws_cloudwatch_event_target" "the_target" {
  ...
  input     = "{\"commands\":[\"cd /home/ubuntu/\",\"cd golang_aws_terraform_jenkins/microservices_restful_ec2/products/source_code\",\"export PORT=${var.products_port}\",\"export db_conn='${local.db_conn}'\",\"sudo chmod 700 main\",\"sudo --preserve-env ./main\"]}"
