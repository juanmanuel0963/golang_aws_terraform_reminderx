...
##################################################################################
# reminderx_admins_login
##################################################################################

module "module_reminderx_admins_login" {
  source                           = "./microservices_reminderx/rmdx_admins_login/terraform"
  region                           = var.region
  access_key                       = var.access_key
  secret_key                       = var.secret_key
  lambda_func_name                 = "rmdx_admins_login"
  random_integer                   = local.random_integer
  random_pet                       = local.random_pet
  parent_api_gateway_id            = module.module_api_gateway.api_gateway_id
  parent_api_gateway_name          = module.module_api_gateway.api_gateway_name
...
##################################################################################
# reminderx_admins_login - OUTPUT
##################################################################################

output "module_reminderx_admins_login_lambda_func_name" {
  description = "Name of the Lambda function."
  value       = module.module_reminderx_admins_login.lambda_func_name
}

output "module_reminderx_admins_login_lambda_func_bucket_name" {
  description = "Name of the S3 bucket used to store function code."
  value       = module.module_reminderx_admins_login.lambda_func_bucket_name
}

output "module_reminderx_admins_login_lambda_func_role_name" {
  description = "Name of the rol"
  value       = module.module_reminderx_admins_login.lambda_func_role_name
}

output "module_reminderx_admins_login_lambda_func_base_url" {
  description = "Base URL for API Gateway stage + function name"
  value       = module.module_reminderx_admins_login.lambda_func_base_url
}
...
module "module_reminderx_clients" {
  source                           = "./microservices_reminderx/rmdx_clients/terraform"
  region                           = var.region
  access_key                       = var.access_key
  secret_key                       = var.secret_key
  lambda_func_name                 = "rmdx_clients"
  random_integer                   = local.random_integer
  random_pet                       = local.random_pet
  parent_api_gateway_id            = module.module_api_gateway.api_gateway_id
  parent_api_gateway_name          = module.module_api_gateway.api_gateway_name
...
##################################################################################
# reminderx_clients - OUTPUT
##################################################################################

output "module_reminderx_clients_admins_lambda_func_name" {
  description = "Name of the Lambda function."
  value       = module.module_reminderx_clients.lambda_func_name
}

output "module_reminderx_clients_lambda_func_bucket_name" {
  description = "Name of the S3 bucket used to store function code."
  value       = module.module_reminderx_clients.lambda_func_bucket_name
}

output "module_reminderx_clients_lambda_func_role_name" {
  description = "Name of the rol"
  value       = module.module_reminderx_clients.lambda_func_role_name
}

output "module_reminderx_clients_lambda_func_base_url" {
  description = "Base URL for API Gateway stage + function name"
  value       = module.module_reminderx_clients.lambda_func_base_url
}


##################################################################################
# reminderx_commitments
##################################################################################

module "module_reminderx_commitments" {
  source                           = "./microservices_reminderx/rmdx_commitments/terraform"
  region                           = var.region
  access_key                       = var.access_key
  secret_key                       = var.secret_key
  lambda_func_name                 = "rmdx_commitments"
  random_integer                   = local.random_integer
  random_pet                       = local.random_pet
  parent_api_gateway_id            = module.module_api_gateway.api_gateway_id
  parent_api_gateway_name          = module.module_api_gateway.api_gateway_name
...
##################################################################################
# reminderx_commitments - OUTPUT
##################################################################################

output "module_reminderx_commitments_admins_lambda_func_name" {
  description = "Name of the Lambda function."
  value       = module.module_reminderx_commitments.lambda_func_name
}

output "module_reminderx_commitments_lambda_func_bucket_name" {
  description = "Name of the S3 bucket used to store function code."
  value       = module.module_reminderx_commitments.lambda_func_bucket_name
}

output "module_reminderx_commitments_lambda_func_role_name" {
  description = "Name of the rol"
  value       = module.module_reminderx_commitments.lambda_func_role_name
}

output "module_reminderx_commitments_lambda_func_base_url" {
  description = "Base URL for API Gateway stage + function name"
  value       = module.module_reminderx_commitments.lambda_func_base_url
}
...
module "module_reminderx_reminders" {
  source                           = "./microservices_reminderx/rmdx_reminders/terraform"
  region                           = var.region
  access_key                       = var.access_key
  secret_key                       = var.secret_key
  lambda_func_name                 = "rmdx_reminders"
  random_integer                   = local.random_integer
  random_pet                       = local.random_pet
  parent_api_gateway_id            = module.module_api_gateway.api_gateway_id
  parent_api_gateway_name          = module.module_api_gateway.api_gateway_name
...
##################################################################################
# reminderx_reminders - OUTPUT
##################################################################################

output "module_reminderx_reminders_admins_lambda_func_name" {
  description = "Name of the Lambda function."
  value       = module.module_reminderx_reminders.lambda_func_name
}

output "module_reminderx_reminders_lambda_func_bucket_name" {
  description = "Name of the S3 bucket used to store function code."
  value       = module.module_reminderx_reminders.lambda_func_bucket_name
}

output "module_reminderx_reminders_lambda_func_role_name" {
  description = "Name of the rol"
  value       = module.module_reminderx_reminders.lambda_func_role_name
}

output "module_reminderx_reminders_lambda_func_base_url" {
  description = "Base URL for API Gateway stage + function name"
  value       = module.module_reminderx_reminders.lambda_func_base_url
}
